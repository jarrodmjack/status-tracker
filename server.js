...
const server = http.createServer((req, res) => { // use http module and use createServer method to create server
  ...
  } else if (page === '/api') { //checks to see if on API page
    if('student' in params) { //check to see if a student variable is submitted in the URL request
  ...
  } else if (page === '/add-user') { //add user functionality, we are adding users to the students array with the Student class constructor 
